...
export class StylesClass {
  ...
  Wrapper: NotificationStyle = {};
  Containers: NotificationStyle = {
    DefaultStyle: {
      fontFamily: 'inherit',
      position: 'fixed',
      width: defaultWidth,
  ...
  NotificationItem: NotificationStyle = {
    DefaultStyle: {
      position: 'relative',
      width: '100%',
      cursor: 'pointer',
  ...
  MessageWrapper: NotificationStyle = {
    DefaultStyle: {
      margin: 0,
      paddingRight: '10px'
    }
  ...
  ActionWrapper: NotificationStyle = {
    DefaultStyle: {
      margin: 0,
      padding: 0
    }
