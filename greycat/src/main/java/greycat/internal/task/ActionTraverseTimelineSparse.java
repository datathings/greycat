...
class ActionTraverseTimelineSparse implements Action {

    private final String _start;
    private final String _end;
    private final String _limit;

    ActionTraverseTimelineSparse(final String p_start, final String p_end, final String p_limit) {
        this._start = p_start;
        this._end = p_end;
        this._limit = p_limit;
    }
    ...
    public final void eval(final TaskContext ctx) {
        ...
        for (int i = 0; i < previousSize; i++) {
            ...
            if (obj instanceof BaseNode) {
                ...
                int finalI = i;
                ctx.graph().lookupTimesSparse(casted.world(), start, end, casted.id(), limit, new Callback<Node[]>() {
                    @Override
    ...
    public final void serialize(final Buffer builder) {
        builder.writeString(CoreActionNames.TRAVERSE_TIMELINE_SPARSE);
    ...
    public final String name() {
        return CoreActionNames.TRAVERSE_TIMELINE_SPARSE;
    }
