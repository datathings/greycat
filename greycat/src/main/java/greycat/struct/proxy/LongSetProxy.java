...
public class LongSetProxy implements LongSet {
    private final int _index;
    private Container _target;
    private LongSet _elem;

    public LongSetProxy(final int _relationIndex, final Container _target, final LongSet _relation) {
    ...
    private void check() {
        if (_target != null) {
            _elem = (LongSet) _target.rephase().getRawAt(_index);
            _target = null;
        }
    }
