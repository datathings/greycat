...
public abstract class AbstractLongSetTest {
    private MemoryFactory factory;

    public AbstractLongSetTest(MemoryFactory factory) {
    ...
    public void genericTest() {
        ...
        LongSet set = (LongSet) chunk.getOrCreateAt(0, Type.LONG_SET);
